// Icon library for S3 Explorer
// Provides consistent, well-designed icons for all common actions
...
export const Icons = {
  ...
  // Loading
  Loading: (
    <svg className="animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
